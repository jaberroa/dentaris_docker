    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box d-flex align-items-center justify-content-between">
                <div>
                    <h4 class="fs-16 fw-semibold mb-1 mb-md-2">Editar Paciente</h4>
                    <p class="text-muted mb-0">Modifica la información de {{ $patient->first_name }} {{ $patient->last_name }}.</p>
                </div>
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control @error('phone_secondary') is-invalid @enderror" 
                                           id="phone_secondary" name="phone_secondary" value="{{ old('phone_secondary', $patient->phone_secondary) }}"
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <select class="form-select @error('marital_status') is-invalid @enderror" id="marital_status" name="marital_status">
                                        <option value="">Seleccionar...</option>
                                        <option value="single" {{ old('marital_status', $patient->marital_status) == 'single' ? 'selected' : '' }}>Soltero(a)</option>
                                        <option value="married" {{ old('marital_status', $patient->marital_status) == 'married' ? 'selected' : '' }}>Casado(a)</option>
                                        <option value="divorced" {{ old('marital_status', $patient->marital_status) == 'divorced' ? 'selected' : '' }}>Divorciado(a)</option>
                                        <option value="widowed" {{ old('marital_status', $patient->marital_status) == 'widowed' ? 'selected' : '' }}>Viudo(a)</option>
                                    </select>
                            ...
                            <div class="col-12">
                                <div class="mb-3">
                                    ...
                                    <textarea class="form-control @error('medical_history') is-invalid @enderror" 
                                              ...
                                              placeholder="Enfermedades, cirugías, hospitalizaciones...">{{ old('medical_history', $patient->medical_history) }}</textarea>
                            ...
                            <div class="col-12">
                                <div class="mb-3">
                                    ...
                                    <textarea class="form-control @error('dental_history') is-invalid @enderror" 
                                              ...
                                              placeholder="Tratamientos anteriores, prótesis, ortodoncia...">{{ old('dental_history', $patient->dental_history) }}</textarea>
                            ...
                            <div class="col-12">
                                <div class="mb-3">
                                    ...
                                    <textarea class="form-control @error('allergies') is-invalid @enderror" 
                                              ...
                                              placeholder="Medicamentos, materiales, alimentos...">{{ old('allergies', $patient->allergies) }}</textarea>
                                    @error('allergies')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="col-12">
                                <div class="mb-3">
                                    ...
                                    <textarea class="form-control @error('medications') is-invalid @enderror" 
                                              ...
                                              placeholder="Medicamentos que toma actualmente...">{{ old('medications', $patient->medications) }}</textarea>
                                    @error('medications')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                    ...
                    <div class="card-body">
                        ...
                        <div class="mb-3">
                            ...
                            <select class="form-select @error('emergency_contact_relationship') is-invalid @enderror" 
                                ...
                                <option value="">Seleccionar...</option>
                                <option value="spouse" {{ old('emergency_contact_relationship', $patient->emergency_contact_relationship) == 'spouse' ? 'selected' : '' }}>Cónyuge</option>
                                <option value="parent" {{ old('emergency_contact_relationship', $patient->emergency_contact_relationship) == 'parent' ? 'selected' : '' }}>Padre/Madre</option>
                                <option value="child" {{ old('emergency_contact_relationship', $patient->emergency_contact_relationship) == 'child' ? 'selected' : '' }}>Hijo(a)</option>
                                <option value="sibling" {{ old('emergency_contact_relationship', $patient->emergency_contact_relationship) == 'sibling' ? 'selected' : '' }}>Hermano(a)</option>
                                <option value="friend" {{ old('emergency_contact_relationship', $patient->emergency_contact_relationship) == 'friend' ? 'selected' : '' }}>Amigo(a)</option>
                                <option value="other" {{ old('emergency_contact_relationship', $patient->emergency_contact_relationship) == 'other' ? 'selected' : '' }}>Otro</option>
                            </select>
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control @error('emergency_contact_address') is-invalid @enderror" 
                                      id="emergency_contact_address" name="emergency_contact_address" rows="2">{{ old('emergency_contact_address', $patient->emergency_contact_address) }}</textarea>
                    ...
                    <div class="card-body">
                        <div class="mb-3">
                            ...
                            <textarea class="form-control @error('notes') is-invalid @enderror" 
                                      ...
                                      placeholder="Información adicional sobre el paciente...">{{ old('notes', $patient->notes) }}</textarea>
                            @error('notes')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="mb-3">
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" id="consent_marketing" 
                                       name="consent_marketing" value="1" {{ old('consent_marketing', $patient->consent_marketing) ? 'checked' : '' }}>
                        ...
                        <div class="mb-3">
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" id="consent_data_processing" 
                                       name="consent_data_processing" value="1" {{ old('consent_data_processing', $patient->consent_data_processing ?? true) ? 'checked' : '' }}>
                        ...
                        <div class="mb-3">
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" id="is_active" 
                                       name="is_active" value="1" {{ old('is_active', $patient->is_active) ? 'checked' : '' }}>
