    ...
    select2: {
        language: {
            ...
            inputTooShort: function() {
                return "Ingresa al menos 1 carácter";
            }
        },
...
function initializePatientSelect2(selector, options = {}) {
    console.log('Initializing patient select2 for selector:', selector);
    const defaultOptions = {
        ...
        ajax: {
            ...
            data: function (params) {
                console.log('Searching patients with term:', params.term);
                return {
                    search: params.term || '',
                    page: params.page || 1
                };
    ...
    console.log('Final options for patient select2:', finalOptions);
    $(selector).select2(finalOptions);
    console.log('Patient select2 initialized successfully');
}
...
console.log('Appointments.js cargado correctamente');
